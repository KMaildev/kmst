<div class="tp-hero-area tp-hero-five__ptb-5 p-relative grey-bg-2 fix">
            ...
            <div class="col-xl-7 col-lg-6 order-2">
                <div class="tp-hero-five-section-wrap">
                    <div class="tp-hero-five-section-box z-index">
                        ...
                        <p class="wow tpfadeUp" data-wow-duration=".9s" data-wow-delay=".5s">A simple
                            solution for building the optimal work <br>
                    ...
                    <div class="tp-hero-five-btn-box d-flex align-items-center wow tpfadeUp"
                        ...
                        <a class="tp-btn-blue-lg purple-bg circle-effect mr-15 mb-20" href="#">Get
                            Started</a>
    ...
    <div class="tp-hero-five-2-thumb-main p-relative">
        <div class="tp-hero-five-2-thumb">
            <img class="tp-hero-five-2-thumb-inner"
                src="{{ asset('assets/img/hero/hero-shape-5-1-1.png') }}" alt="">
        </div>
